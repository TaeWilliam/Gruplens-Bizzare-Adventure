...
public class SvenskerEntity extends Monster {
	public SvenskerEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GbaModEntities.SVENSKER.get(), world);
	}

	public SvenskerEntity(EntityType<SvenskerEntity> type, Level world) {
		super(type, world);
		xpReward = 20;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(GbaModEntities.SVENSKER.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
