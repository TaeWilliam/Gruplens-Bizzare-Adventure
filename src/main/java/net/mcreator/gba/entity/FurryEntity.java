...
public class FurryEntity extends Monster {
	public FurryEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GbaModEntities.FURRY.get(), world);
	}
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(5, new NearestAttackableTargetGoal(this, HeavyEntity.class, false, false));
		this.targetSelector.addGoal(6, new NearestAttackableTargetGoal(this, ScoutEntity.class, false, false));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(GbaModItems.ASH.get()));
	}
