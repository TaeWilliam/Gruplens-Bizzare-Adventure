...
public class TrueBrondbyEntity extends Monster implements RangedAttackMob {
	public TrueBrondbyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GbaModEntities.TRUE_BRONDBY.get(), world);
	}

	public TrueBrondbyEntity(EntityType<TrueBrondbyEntity> type, Level world) {
		super(type, world);
		xpReward = 30;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(1, new RangedAttackGoal(this, 1.25, 10, 20f) {
			@Override
	...
	public void performRangedAttack(LivingEntity target, float flval) {
		GlockEntity.shoot(this, target);
	}

	public static void init() {
		SpawnPlacements.register(GbaModEntities.TRUE_BRONDBY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
