...
public class BrondbyEntity extends Monster {
	public BrondbyEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(GbaModEntities.BRONDBY.get(), world);
	}

	public BrondbyEntity(EntityType<BrondbyEntity> type, Level world) {
		super(type, world);
		xpReward = 30;
		setNoAi(false);
	}
	...
	public static void init() {
		SpawnPlacements.register(GbaModEntities.BRONDBY.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
